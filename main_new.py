...
from voice import audio, get_supported_languages
...
def main():
    ...
    if input_landmark is not None:
        ...
        st.write("Select Language for in which the text is to be converted ")
        ...
        gender_map = {
                        "Neutral": texttospeech.SsmlVoiceGender.SSML_VOICE_GENDER_UNSPECIFIED,
